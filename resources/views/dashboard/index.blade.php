    ...
    <div class="flex items-center justify-center px-6 py-8 md:h-screen lg:py-0">
      <div class="w-96 rounded-lg max-w-md bg-gray-800">
        <div class="p-4 space-y-4 items-center flex justify-center mt-5">
          <button class="font-bold text-2xl bg-sky-600 hover:bg-sky-800 text-white rounded-xl p-2 px-10" id="increaseGemsBtn">Grind</button>
        </div>
        <div class="p-4 space-y-4 items-center flex justify-center">
          <a href="/gacha">
            <button class="font-bold text-2xl bg-sky-600 hover:bg-sky-800 text-white rounded-xl p-2 px-10">
              Gacha
            </button>
          </a>
        </div>
